...
// off the data: { kind, refId, refKind } payload notifyUser attaches
// (section B3, widened for SP8 Task 17). Null for a kind with no
// destination or a legacy push without data, in which case the tap just
// foregrounds the app, exactly as before. `refKind` lets a
// saved_search_match push route to the event/gig page the same way
